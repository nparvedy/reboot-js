var nomDeLaVariable = prompt('Bonjour tu vas bien ? (oui ou non)');
if (nomDeLaVariable === 'oui'){
    nomDeLaVariable = prompt('Tu préfères le rouge ou le bleu ?');
    if (nomDeLaVariable === "bleu"){
    ...
    nomDeLaVariable = prompt('Tu préfères les chiens ou chats ?');
